...
def main():
    ...
    #fit logistic CU K FIXAT pe 2012-2025
    ...
    #extindem logisticul pana in 1900-01-01
    ...
    #model State Space pe reziduu (nivel + sezonalitate)
    ...
    print("Saved: craiova_logistic_state_space_1900_2025.csv")
    ...
    plt.close()
    print("Saved: craiova_logistic_state_space_1900_2025.png")
